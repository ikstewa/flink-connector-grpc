...
public class GrpcLookupTableSourceFactory implements DynamicTableSourceFactory {
  ...
  public Set<ConfigOption<?>> optionalOptions() {
    return Set.of(
        ...
        GrpcConnectorOptions.GRPC_REQUEST_TIMEOUT,
  ...
  public DynamicTableSource createDynamicTableSource(Context context) {
    ...
    return new GrpcLookupTableSource(
        new GrpcServiceOptions(
            ...
            tableOptions.get(GrpcConnectorOptions.GRPC_REQUEST_TIMEOUT),
            tableOptions.get(GrpcConnectorOptions.GRPC_RETRY_CODES),
            tableOptions.get(GrpcConnectorOptions.GRPC_ERROR_CODES),
            tableOptions.get(GrpcConnectorOptions.GRPC_DEDUPLICATE_REQUESTS)),
